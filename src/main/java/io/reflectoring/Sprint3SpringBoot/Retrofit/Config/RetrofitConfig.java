...
public class RetrofitConfig {
    ...
    private static final String BASE_URL_DEVICE = "http://localhost:5173/api/device";
    private static final String BASE_URL_CONTINUOUSUSEDEVICE = "http://localhost:5173/api/continuoususedevice";
    private static final String BASE_URL_FOUNTAIN = "http://localhost:5173/api/fountain";
    private static final String BASE_URL_WATERANALYSIS = "http://localhost:5173/api/wateranalysis";
